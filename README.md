...
2. This program will take an Excel document, read through each column that you noted, and put it into a text file with tab delimiters to seperate each column entry. Note that first/last names are also separated by tabs.
